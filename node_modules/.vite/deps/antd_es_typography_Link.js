...
var Tooltip = function Tooltip2(props, ref) {
  ...
  return React22.createElement(es_default4, _extends({
...
var InternalTooltip = React27.forwardRef((props, ref) => {
  ...
  const content = React27.createElement(es_default5, Object.assign({}, otherProps, {
    zIndex,
...
var ResizableTextArea = React28.forwardRef(function(props, ref) {
  ...
  return React28.createElement(es_default2, {
...
var TextArea = import_react5.default.forwardRef(function(_ref, ref) {
  ...
  if (countConfig.show) {
    ...
    suffixNode = import_react5.default.createElement(import_react5.default.Fragment, null, suffixNode, import_react5.default.createElement("span", {
      className: (0, import_classnames10.default)("".concat(prefixCls, "-data-count"), classNames15 === null || classNames15 === void 0 ? void 0 : classNames15.count),
  ...
  return import_react5.default.createElement(BaseInput_default, {
    ...
    suffix: suffixNode,
    prefixCls,
    classNames: _objectSpread2(_objectSpread2({}, classNames15), {}, {
      affixWrapper: (0, import_classnames10.default)(classNames15 === null || classNames15 === void 0 ? void 0 : classNames15.affixWrapper, _defineProperty(_defineProperty({}, "".concat(prefixCls, "-show-count"), showCount), "".concat(prefixCls, "-textarea-allow-clear"), allowClear))
    }),
    disabled,
    focused,
    ...
    className: (0, import_classnames10.default)(classNames15 === null || classNames15 === void 0 ? void 0 : classNames15.textarea),
...
var TextArea2 = (0, import_react6.forwardRef)((props, ref) => {
  var _a, _b;
  const {
    prefixCls: customizePrefixCls,
    bordered = true,
  ...
  const disabled = React30.useContext(DisabledContext_default);
  const mergedDisabled = customDisabled !== null && customDisabled !== void 0 ? customDisabled : disabled;
  const {
    status: contextStatus,
    hasFeedback,
    feedbackIcon
  } = React30.useContext(FormItemInputContext);
  const mergedStatus = getMergedStatus(contextStatus, customStatus);
  const innerRef = React30.useRef(null);
  ...
  return wrapCSSVar(React30.createElement(es_default6, Object.assign({
    ...
    className: (0, import_classnames11.default)(cssVarCls, rootCls, className, rootClassName, textArea === null || textArea === void 0 ? void 0 : textArea.className),
    classNames: Object.assign(Object.assign(Object.assign({}, classes), textArea === null || textArea === void 0 ? void 0 : textArea.classNames), {
      textarea: (0, import_classnames11.default)({
      ...
      affixWrapper: (0, import_classnames11.default)(`${prefixCls}-textarea-affix-wrapper`, {
    ...
    prefixCls,
    suffix: hasFeedback && React30.createElement("span", {
...
var Editable = (props) => {
  const {
    ...
    onEnd,
    component,
    enterIcon = React31.createElement(EnterOutlined_default, null)
  } = props;
  const ref = React31.useRef(null);
  const inComposition = React31.useRef(false);
  const lastKeyCode = React31.useRef();
  const [current, setCurrent] = React31.useState(value);
  React31.useEffect(() => {
    setCurrent(value);
  }, [value]);
  React31.useEffect(() => {
  ...
  const textAreaClassName = (0, import_classnames12.default)(prefixCls, `${prefixCls}-edit-content`, {
    [`${prefixCls}-rtl`]: direction === "rtl"
  }, className, textClassName, hashId, cssVarCls);
  return wrapCSSVar(React31.createElement("div", {
    className: textAreaClassName,
    style
  }, React31.createElement(TextArea_default2, {
    ref,
    maxLength,
    value: current,
    onChange,
...
var useCopyClick = (_ref) => {
  ...
  const [copyLoading, setCopyLoading] = React32.useState(false);
  const copyIdRef = React32.useRef(null);
  const cleanCopyId = () => {
...
var useUpdatedEffect = (callback, conditions) => {
  const mountRef = React34.useRef(false);
  React34.useEffect(() => {
    if (mountRef.current) {
      callback();
    } else {
...
var Typography = React35.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
  ...
  const [wrapCSSVar, hashId, cssVarCls] = style_default3(prefixCls);
  const componentClassName = (0, import_classnames13.default)(prefixCls, typography === null || typography === void 0 ? void 0 : typography.className, {
    [`${prefixCls}-rtl`]: direction === "rtl"
  ...
  return wrapCSSVar(
    ...
    React35.createElement(Component2, Object.assign({
...
var CopyBtn = (props) => {
  ...
  return React36.createElement(tooltip_default, {
    key: "copy",
    title: copyTitle
  }, React36.createElement(transButton_default, {
    className: (0, import_classnames14.default)(`${prefixCls}-copy`, {
    ...
    "aria-label": ariaLabel,
    tabIndex
  }, copied ? getNode(iconNodes[1], React36.createElement(CheckOutlined_default, null), true) : getNode(iconNodes[0], btnLoading ? React36.createElement(LoadingOutlined_default, null) : React36.createElement(CopyOutlined_default, null), true)));
};
var CopyBtn_default = CopyBtn;

// node_modules/antd/es/typography/Base/Ellipsis.js
var React37 = __toESM(require_react());
var MeasureText = React37.forwardRef((_ref, ref) => {
  let {
    style,
    children
  } = _ref;
...
function EllipsisMeasure(props) {
  ...
  const nodeList = React37.useMemo(() => toArray(text), [text]);
  const nodeLen = React37.useMemo(() => getNodesLen(nodeList), [text]);
  const fullContent = React37.useMemo(() => children(nodeList, false), [text]);
  const [ellipsisCutIndex, setEllipsisCutIndex] = React37.useState(null);
  const cutMidRef = React37.useRef(null);
  const measureWhiteSpaceRef = React37.useRef(null);
  const needEllipsisRef = React37.useRef(null);
  const descRowsEllipsisRef = React37.useRef(null);
  const symbolRowEllipsisRef = React37.useRef(null);
  const [canEllipsis, setCanEllipsis] = React37.useState(false);
  const [needEllipsis, setNeedEllipsis] = React37.useState(STATUS_MEASURE_NONE);
  const [ellipsisHeight, setEllipsisHeight] = React37.useState(0);
  const [parentWhiteSpace, setParentWhiteSpace] = React37.useState(null);
  useLayoutEffect_default(() => {
  ...
  const finalContent = React37.useMemo(() => {
  ...
  return React37.createElement(React37.Fragment, null, finalContent, needEllipsis === STATUS_MEASURE_START && React37.createElement(React37.Fragment, null, React37.createElement(MeasureText, {
    style: Object.assign(Object.assign(Object.assign({}, measureStyle), lineClipStyle), {
      WebkitLineClamp: rows
    }),
    ref: needEllipsisRef
  }, fullContent), React37.createElement(MeasureText, {
    style: Object.assign(Object.assign(Object.assign({}, measureStyle), lineClipStyle), {
  ...
  }, children([], true))), needEllipsis === STATUS_MEASURE_NEED_ELLIPSIS && ellipsisCutIndex && ellipsisCutIndex[0] !== ellipsisCutIndex[1] && React37.createElement(MeasureText, {
    style: Object.assign(Object.assign({}, measureStyle), {
      top: 400
    }),
    ref: cutMidRef
  }, children(sliceNodes(nodeList, cutMidIndex), true)), needEllipsis === STATUS_MEASURE_PREPARE && React37.createElement("span", {
    style: {
      whiteSpace: "inherit"
    },
...
var EllipsisTooltip = (_ref) => {
  ...
  return React38.createElement(tooltip_default, Object.assign({
...
function wrapperDecorations(_ref, content) {
  ...
  function wrap(tag, needed) {
    ...
    currentContent = React39.createElement(tag, {}, currentContent);
  }
  wrap("strong", strong);
  wrap("u", underline);
  wrap("del", del);
...
var ELLIPSIS_STR = "...";
var Base = React39.forwardRef((props, ref) => {
  var _a, _b, _c;
  const {
    prefixCls: customizePrefixCls,
    className,
  ...
  const typographyRef = React39.useRef(null);
  const editIconRef = React39.useRef(null);
  const prefixCls = getPrefixCls("typography", customizePrefixCls);
  ...
  const [isLineClampSupport, setIsLineClampSupport] = React39.useState(false);
  const [isTextOverflowSupport, setIsTextOverflowSupport] = React39.useState(false);
  const [isJsEllipsis, setIsJsEllipsis] = React39.useState(false);
  const [isNativeEllipsis, setIsNativeEllipsis] = React39.useState(false);
  const [isNativeVisible, setIsNativeVisible] = React39.useState(true);
  ...
  const needMeasureEllipsis = React39.useMemo(() => (
    // Disable ellipsis
  ...
  const [cssEllipsis, setCssEllipsis] = React39.useState(mergedEnableEllipsis);
  const canUseCssEllipsis = React39.useMemo(() => {
  ...
  const [ellipsisWidth, setEllipsisWidth] = React39.useState(0);
  ...
  } else if (React39.isValidElement(ellipsisConfig.tooltip)) {
    tooltipProps = {
  ...
  const topAriaLabel = React39.useMemo(() => {
  ...
  if (editing) {
    return React39.createElement(Editable_default, {
  ...
  const renderExpand = () => {
    ...
    return React39.createElement(transButton_default, {
      key: "expand",
  ...
  const renderEdit = () => {
    ...
    return triggerType.includes("icon") ? React39.createElement(tooltip_default, {
      key: "edit",
      title: tooltip === false ? "" : editTitle
    }, React39.createElement(transButton_default, {
      ref: editIconRef,
      className: `${prefixCls}-edit`,
      onClick: onEditClick,
      "aria-label": ariaLabel,
      tabIndex
    }, icon || React39.createElement(EditOutlined_default, {
      role: "button"
    }))) : null;
  };
  const renderCopy = () => {
    ...
    return React39.createElement(CopyBtn_default, Object.assign({
      key: "copy"
    }, copyConfig, {
      prefixCls,
      copied,
  ...
  const renderEllipsis = (canEllipsis) => [canEllipsis && !expanded && React39.createElement("span", {
    "aria-hidden": true,
    key: "ellipsis"
  }, ELLIPSIS_STR), ellipsisConfig.suffix, renderOperations(canEllipsis)];
  return React39.createElement(es_default2, {
    onResize: onResize2,
    disabled: !mergedEnableEllipsis
  }, (resizeRef) => React39.createElement(EllipsisTooltip_default, {
    tooltipProps,
    enableEllipsis: mergedEnableEllipsis,
    isEllipsis: isMergedEllipsis
  }, React39.createElement(Typography_default, Object.assign({
    ...
    title
  }, textProps), React39.createElement(EllipsisMeasure, {
  ...
  }, (node, canEllipsis) => wrapperDecorations(props, React39.createElement(React39.Fragment, null, node.length > 0 && canEllipsis && !expanded && topAriaLabel ? React39.createElement("span", {
    key: "show-content",
    "aria-hidden": true
...
var Link = React40.forwardRef((_a, ref) => {
  var {
    ellipsis,
    rel
  } = _a, restProps = __rest6(_a, ["ellipsis", "rel"]);
  if (true) {
  ...
  return React40.createElement(Base_default, Object.assign({}, mergedProps, {
    ref,
    ellipsis: !!ellipsis,
    component: "a"
  }));
